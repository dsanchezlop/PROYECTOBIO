...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 09-03-2023 a las 17:09:04
...
('root', '[{\"db\":\"proyecto-bio\",\"table\":\"users\"}]');
...
('root', '2023-03-09 15:33:17', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"es\"}');
...
--
CREATE DATABASE IF NOT EXISTS `proyecto-bio` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `proyecto-bio`;
